...
enum PAVO2_CMD_INDEX {
    ...
    CMD_UDPPORT, 
	CMD_OUTDOOR,
	CMD_ANGLE_RANGLE_ENABLE,

	CMD_ANGLE_RESOLUTION_ENABLE, //20
	CMD_MOTOR_SPEED_ENABLE,
	CMD_MAX_DISTANCE,
	CMD_CAL_HOR_ANGLE,
...
static const unsigned char PAVO2_CMD[][CMD_INDEX_LEN] = {
    ...
    { 0xEB, 0x90, 0x00, 0xE1 },  //SET_IP  //15
    { 0xEB, 0x90, 0x00, 0xE2 },  //SET_TCP_PORT 
    { 0xEB, 0x90, 0x00, 0xE3 },  //UDP_PORT 
	{ 0xEB, 0x90, 0x00, 0xB0 },  //OUTDOOR
	{ 0xEB, 0x90, 0x00, 0xAF },  //CMD_ANGLE_RANGLE_ENABLE

	{ 0xEB, 0x90, 0x00, 0xB3 },  //CMD_ANGLE_RESOLUTION_ENABLE
	{ 0xEB, 0x90, 0x00, 0xB2 },  //CMD_MOTOR_SPEED_ENABLE
	{ 0xEB, 0x90, 0x00, 0xB1 },  //CMD_MAX_DISTANCE
	{ 0xEB, 0x90, 0x00, 0xB4 },  //CMD_CAL_HOR_ANGLE
};
